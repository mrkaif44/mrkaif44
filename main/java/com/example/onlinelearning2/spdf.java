...
import com.example.onlinelearning2.databinding.ActivityHomeBinding;
import com.example.onlinelearning2.databinding.ActivitySpdfBinding;

import kotlin.LateinitKt;

public class spdf extends AppCompatActivity {
       ...
       science1=findViewById(R.id.science1);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(spdf.this, home.class);
        ...
        urdu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(spdf.this, displaypdf.class);
                intent.putExtra("pdf_url", "https://drive.google.com/file/d/1EHw90C17LCFizZM59f0jHTtpUahLTnEu/preview");
                startActivity(intent);
            }
        });
