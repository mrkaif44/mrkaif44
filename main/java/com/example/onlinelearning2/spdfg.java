...
public class spdfg extends AppCompatActivity {
    ImageView btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_spdfg);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(spdfg.this, home.class);
        ...
        urdu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(spdfg.this, displaypdf.class);
                intent.putExtra("pdf_url", "https://drive.google.com/drive/home");
                startActivity(intent);
            }
        });
